          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-white flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mr-3 text-[#8B5CF6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8m0 8l-6-2m6 2l6-2m0-5l-9-2m9 2L3 7m6 2v8m0-8l6-2m-6 2l-6-2" />
                </svg>
                Izvještaj Izlaznih Operacija Goriva
              </h2>
              <p className="text-gray-400 mt-2">Pregled svih operacija točenja goriva u avione</p>
            </div>
          </div>
        </div>

        <div className="p-12 text-center">
          <svg className="animate-spin h-10 w-10 text-slate-600 mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div className="p-6 bg-gray-50 border-b border-gray-200">
              <h3 className="text-lg font-medium text-gray-900 flex items-center">
                <FunnelIcon className="h-5 w-5 text-slate-600 mr-2" />
                Filteri izvještaja
              </h3>
            </div>
            ...
            <div className="p-6">
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <label htmlFor="airlines" className="text-sm font-medium text-gray-700">Avio Kompanije</label>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
                        className="w-full justify-start text-left font-normal border-gray-300 hover:border-gray-400 hover:shadow-sm transition-all"
                ...
                <div className="space-y-2">
                  <label htmlFor="trafficType" className="text-sm font-medium text-gray-700">Tip saobraćaja</label>
                  <select
                    id="trafficType"
                ...
                <div className="space-y-2">
                  <label htmlFor="dateFrom" className="text-sm font-medium text-gray-700">Datum Od</label>
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant={"outline"}
                        className={`w-full justify-start text-left font-normal border-gray-300 hover:border-gray-400 hover:shadow-sm transition-all ${!filterDateFrom && "text-gray-500"}`}
                      >
                ...
                <div className="space-y-2">
                  <label htmlFor="dateTo" className="text-sm font-medium text-gray-700">Datum Do</label>
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant={"outline"}
                        className={`w-full justify-start text-left font-normal border-gray-300 hover:border-gray-400 hover:shadow-sm transition-all ${!filterDateTo && "text-gray-500"}`}
                      >
                        <CalendarIcon className="mr-2 h-4 w-4" />
                ...
                <div className="space-y-2">
                  <label htmlFor="destinations" className="text-sm font-medium text-gray-700">Destinacije</label>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center space-x-2">
                            <input
                              ...
                              className="h-4 w-4 text-slate-600 focus:ring-slate-500 border-gray-300 rounded"
                            />
                            <label htmlFor="select-all-destinations" className="text-sm font-medium text-gray-700">
                              Odaberi sve
                            </label>
                          </div>
                          <div className="border-t border-gray-200 pt-2">
                            {destinationOptions.filter(option => option.value !== '__ALL__').map(destination => (
                              <div key={destination.value} className="flex items-center space-x-2 py-1">
                                <input
                                  ...
                                  className="h-4 w-4 text-slate-600 focus:ring-slate-500 border-gray-300 rounded"
                                />
                                <label htmlFor={`destination-${destination.value}`} className="text-sm text-gray-700">
                                  {destination.label}
                                </label>
                              </div>
                            ))}
                ...
                <div className="space-y-2">
                  <label htmlFor="deliveryVoucher" className="text-sm font-medium text-gray-700">Broj dostavnice</label>
                  <input
                    type="text"
                    id="deliveryVoucher"
                ...
                <div className="space-y-2">
                  <label htmlFor="currency" className="text-sm font-medium text-gray-700">Valuta</label>
                  <select
                    id="currency"
                ...
                <div className="space-y-2">
                  <label htmlFor="payment_method" className="text-sm font-medium text-gray-700">Način Plaćanja</label>
                  <select
                    id="payment_method"
                ...
                <div className="flex items-end">
                  <Button
                    ...
                    variant="outline"
                    className="w-full border-gray-300 text-gray-900 hover:border-gray-400 hover:bg-gray-200 hover:text-gray-900 transition-all"
                  >
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            {(!operations || operations.length === 0) && !loading && (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-gray-700 font-medium">Nema zabilježenih izlaznih operacija goriva.</p>
              </div>
            )}
            ...
            {operations && operations.length > 0 && (
              <>
                <div style={{ width: '100%', overflowX: 'auto', overflowY: 'auto', maxHeight: '60vh', position: 'relative' }}>
                  <table style={{ width: '100%', tableLayout: 'fixed', minWidth: '1200px', fontSize: '0.7rem' }} className="divide-y divide-gray-200">
                    <thead className="bg-gray-50 border-b border-gray-200">
                      <tr>
                        <th scope="col" className="px-3 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '8%' }}>Datum</th>
                        <th scope="col" className="px-3 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '5%' }}>Reg.</th>
                        <th scope="col" className="px-3 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '10%' }}>Avio Komp.</th>
                        <th scope="col" className="px-3 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '4%' }}>Dest.</th>
                        <th scope="col" className="px-3 py-2 text-right text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '6%' }}>Kol. (L)</th>
                        <th scope="col" className="px-3 py-2 text-right text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '6%' }}>Spec. Gust.</th>
                        <th scope="col" className="px-3 py-2 text-right text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '6%' }}>Kol. (kg)</th>
                        <th scope="col" className="px-3 py-2 text-right text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '6%' }}>Cijena/kg</th>
                        <th scope="col" className="px-3 py-2 text-center text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '3%' }}>Val.</th>
                        <th scope="col" className="px-3 py-2 text-right text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '8%' }}>Ukupna cijena</th>
                        <th scope="col" className="px-3 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '6%' }}>Br. Leta</th>
                        <th scope="col" className="px-3 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '7%' }}>Broj dostavnice</th>
                        <th scope="col" className="px-3 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '7%' }}>MRN podaci</th>
                        <th scope="col" className="px-3 py-2 text-center text-xs font-semibold text-gray-700 uppercase tracking-wider" style={{ wordWrap: 'break-word', width: '5%' }}>Način plaćanja</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                      {operations.map((op) => (
                        ...
                        >
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 table-cell-wrap">{formatDate(op.dateTime)}</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 table-cell-wrap">
                            {op.aircraft_registration ? (
                              <span className="inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium text-[0.65rem] bg-blue-100 text-blue-800">
                                {op.aircraft_registration}
                              </span>
                            ) : (
                          ...
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 table-cell-wrap">{op.airline?.name || <Badge variant="outline" className="text-[0.65rem] py-0 h-4">N/A</Badge>}</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 table-cell-wrap">{op.destination || <Badge variant="outline" className="text-[0.65rem] py-0 h-4">N/A</Badge>}</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 font-medium text-right table-cell-wrap">{op.quantity_liters.toLocaleString('hr-HR')} L</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 font-medium text-right table-cell-wrap">{(op.specific_density || 0).toLocaleString('hr-HR', { minimumFractionDigits: 3 })}</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 font-medium text-right table-cell-wrap">{(op.quantity_kg || 0).toLocaleString('hr-HR')} kg</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 font-medium text-right table-cell-wrap">{(op.price_per_kg || 0).toLocaleString('hr-HR', { minimumFractionDigits: 2 })}</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 font-medium text-center table-cell-wrap">{op.currency || 'BAM'}</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 font-medium text-right table-cell-wrap">{Number(op.total_amount || 0).toFixed(2)}</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 table-cell-wrap">{op.flight_number || <Badge variant="outline" className="text-[0.65rem] py-0 h-4">N/A</Badge>}</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 table-cell-wrap">{op.delivery_note_number || <Badge variant="outline" className="text-[0.65rem] py-0 h-4">N/A</Badge>}</td>
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 table-cell-wrap">
                              ...
                              <div className="flex flex-col space-y-1">
                                {op.parsedMrnBreakdown.map((mrnItem, index) => (
                                  <span
                                    ...
                                    className="inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium text-[0.65rem] bg-amber-100 text-amber-800"
                          ...
                          <td className="px-3 py-2 text-[0.68rem] text-gray-700 table-cell-wrap text-center">
                            {op.payment_method ? (
                              <span className="inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium text-[0.65rem] bg-green-100 text-green-800">
                ...
                <div className="bg-gray-50 px-4 py-3 border-t border-gray-200 flex flex-wrap justify-between items-center gap-4">
                  <div className="flex flex-col">
                    <div className="text-sm text-gray-500 mb-1">
                      Prikazano <span className="font-medium text-gray-700">{operations ? operations.length : 0}</span> operacija
                    </div>

                    {/* Totals Summary - Inline */}
                    <div className="flex items-center gap-4 mt-1">
                      <div className="flex flex-col items-center">
                        <span className="text-xs text-gray-500 mb-1">Ukupno litara</span>
                        <div className="flex items-center px-3 py-1 bg-blue-50 rounded-md border border-blue-100">
                      ...
                      <div className="flex flex-col items-center">
                        <span className="text-xs text-gray-500 mb-1">Ukupno kilograma</span>
                        <div className="flex items-center px-3 py-1 bg-green-50 rounded-md border border-green-100">
                      ...
                      <div className="flex flex-col items-center">
                        <span className="text-xs text-gray-500 mb-1">Prosječna gustoća</span>
                        <div className="flex items-center px-3 py-1 bg-purple-50 rounded-md border border-purple-100">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Button
                      onClick={generatePdf}
                      variant="outline"
                      className="border-gray-300 text-gray-900 hover:border-gray-400 hover:bg-stone-100 hover:text-gray-900 whitespace-nowrap transition-all"
                    >
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="border-gray-300 text-gray-900 hover:border-gray-400 hover:bg-zinc-100 hover:text-gray-900 whitespace-nowrap transition-all"
                    >
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="border-gray-300 text-gray-900 hover:border-gray-400 hover:bg-green-50 hover:text-gray-900 whitespace-nowrap transition-all"
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="border-gray-300 text-gray-900 hover:border-gray-400 hover:bg-amber-50 hover:text-gray-900 whitespace-nowrap transition-all"
                      disabled={operations.length === 0}
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="border-gray-300 text-gray-900 hover:border-gray-400 hover:bg-blue-50 hover:text-gray-900 whitespace-nowrap transition-all"
                      disabled={operations.length === 0}
          ...
          <div className="mt-6 p-6 bg-white rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {Object.entries(revenueByCurrency).map(([currency, amount]) => (
                <div key={currency} className="p-4 border rounded-lg bg-gray-50 border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center mr-3 ${
                        currency === 'USD' ? 'bg-green-100 text-green-600' :
                        currency === 'EUR' ? 'bg-blue-100 text-blue-600' :
                    ...
                    <div className={`text-xs font-medium px-2.5 py-0.5 rounded-full ${
                      ...
                      currency === 'EUR' ? 'bg-blue-100 text-blue-800' :
              ...
              {!revenueByCurrency['USD'] && (
                <div className="p-4 border rounded-lg bg-gray-50 border-gray-200">
                  <div className="flex items-center">
                    <div className="w-10 h-10 rounded-full bg-green-100 text-green-600 flex items-center justify-center mr-3">$</div>
                    <div>
                      <p className="text-sm text-gray-500">Ukupan promet</p>
              ...
              {!revenueByCurrency['EUR'] && (
                <div className="p-4 border rounded-lg bg-gray-50 border-gray-200">
                  <div className="flex items-center">
                    <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mr-3">€</div>
                    <div>
                      <p className="text-sm text-gray-500">Ukupan promet</p>
                      <p className="text-xl font-bold text-gray-800">€ 0.00</p>
                    </div>
              ...
              {!revenueByCurrency['BAM'] && (
                <div className="p-4 border rounded-lg bg-gray-50 border-gray-200">
                  <div className="flex items-center">
                    <div className="w-10 h-10 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center mr-3">KM</div>
                    <div>
                      <p className="text-sm text-gray-500">Ukupan promet</p>
                      <p className="text-xl font-bold text-gray-800">KM 0.00</p>
                    </div>
                  </div>
                </div>
              )}
